...
// Full semver string: "MAJOR.MINOR.PATCH[-PRERELEASE][+METADATA]"
#define CORE_VERSION_STRING_SEMVER \
    CORE_VERSION_STRING CORE_VERSION_PRERELEASE CORE_VERSION_METADATA
